...
class check_in_dict():
    ...
    def __init__(self):
        ...
        self.words = {
            ...
            'exclusions_en': exclusions_common + ['for some days', 'booked', 'no menu today', 'we reserve the rights to possible changes', 'rights to possible changes'],  # ignore strings with these items
