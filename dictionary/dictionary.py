...
class check_in_dict():
    ...
    def __init__(self):
        ...
        self.project_tags = {
            ...
            'afw': 'afterwork|after work',

            'srt': 'a la cart',
            'sbf': 'breakfast',
            'slh': 'lunch',
            'sbn': 'brunch|breakfast',
            'saw': 'afterwork|after work',
        }
        ...
        self.weekdays_full = {
            ...
            '0_sv': ['måndag', 'måndagslunch'],
            '1_sv': ['tisdag', 'tisdagslunch'],
            '2_sv': ['onsdag', 'onsdagslunch'],
            '3_sv': ['torsdag', 'torsdagslunch'],
            '4_sv': ['fredag', 'fredagslunch'],
            '5_sv': ['lördag', 'lördagslunch'],
            ...
            '6_fi': ['sunnuntai', 'sunnuntain', 'sunnuntaina', 'sununtai', 'sununtain', 'sununtaina', 'sunnuntaisin', 'sununtaisin', 'su'],
        }
        ...
        exclusions_common = [
            'unauthorized', 'bottom of page', 'top of page', 'toggle main menu', 'toggle menu', 'lorem ipsum', 'et factum est in tricesimo',
            ...
            'posted on',
            'this request','unable to handle this request','http error','this page isn’t working http error 500',
            'expand','adform','tracking code','tracking','upphovsrättslagen','presenteras av','presenteras','visitingarvet.se','visitingarvet','visit ingarvet','lunchguiden.nu','lunchguiden','lunch guiden','kvartersmenyn','kvartersmen','sidan finns inte','collapse','ooops','we are sorry','does not exist','✓','more info','less info','displaying all','on deck','no items found','website expired', 'cookies på denna webbplats','använder cookies','verifying','you are','human','this may take','few seconds','verification','successful',
        ]
        ...
        self.words = {
            ...
            'lunchweekend_sv': ['lunch', 'helgen', 'helger', 'veckans slut', 'veckansslut', 'veckoslut', 'semester', 'högtider', 'helgdag', 'helgdagar', 'lördagsbuffé', 'lördagsmeny'],
            ...
            'lunchsaturday_sv': ['lunch', 'lördag', 'lördagsbuffé', 'lördagsmeny'],
            'lunchsaturday_fi': ['lauantaisin', 'launtaisin', 'lauantailounas', 'lauantai'],
            'lunchsunday_en': ['lunch', 'brunch', 'sunday'],
            'lunchsunday_sv': ['lunch', 'brunch', 'söndag', 'frukost-lunch', 'frukostmiddag', 'söndagsbuffé', 'söndagsmeny'],
            'lunchsunday_fi': ['sunnuntaisin', 'sunnuntasin', 'sunnuntailounas', 'sunnuntai', 'sunnuntaisin brunssi'],
            
            'brunch_en': ['brunch'],
            'brunch_sv': ['brunch', 'frukost-lunch', 'frukostmiddag', 'helgmeny', 'helglunch', 'söndagsbuffé', 'söndagsmeny'],
            ...
            'lunchweekend_lng_sv': ['lunch', 'helgen', 'helger', 'veckans slut', 'veckansslut', 'veckoslut', 'högtider', 'helgdag', 'helgdagar', 'lördagsbuffé', 'lördagsmeny'],  # , 'semester'
            ...
            'lunchsaturday_lng_sv': ['lunch', 'lördag', 'lördagsbuffé', 'lördagsmeny'],
            'lunchsaturday_lng_fi': ['lauantaisin', 'launtaisin', 'lauantailounas', 'lauantai'],
            'lunchsunday_lng_en': ['lunch', 'brunch', 'sunday'],
            'lunchsunday_lng_sv': ['lunch', 'brunch', 'söndag', 'frukost-lunch', 'frukostmiddag', 'söndagsbuffé', 'söndagsmeny'],
            ...
            'brunch_lng_sv': ['brunch', 'helgmeny', 'helglunch', 'helgen', 'helger', 'veckans slut', 'veckansslut', 'veckoslut', 'högtider', 'helgdag', 'helgdagar', 'lördagsbuffé', 'lördagsmeny'],
            ...
            'lunch_simple_sv': ['lunchbuffé', 'lunchbuffe', 'smörgåsbord', 'lunch', 'lunchmeny', 'lunch meny', 'lunchmenyn', 'lunchmenyer', 'veckans meny', 'veckomeny', 'vecko meny', 'veckans', 'dagens lunch', 'dagens meny', 'dagmeny', 'lunchpizzor', 'husets special', 'asiatisk buffé', 'tisdag lunch', 'lunchbuffé', 'lunch rätter', 'lunchrätter', 'lunchratter', 'dagens rätter', 'dagens ratter', 'veckans kött', 'veckans fisk', 'veckans lunchmeny', 'veckans lunch meny', 'dagens rätt', 'dagens ratt', 'vegetarisk lunchalternativ', 'lunchalternativ', 'lunch-a\'la carte', 'lunch-a la carte', 'alacarte lunch', 'a la carte lunch', 'dagens lunchbuffé', 'dagens lunchbuffe', 'veckans soppa', 'dagens soppa', 'sopplunch', 'dagens husman', 'dagens vegan', 'fredags lunch', 'buffet', 'le-dejeuner', 'le_dejeuner', 'ledejeuner', 'le dejeuner'],
            'lunch_simple_fi': ['lounas tänään', 'lounas arkisin', 'lounas lista', 'lounaslista', 'lounasmenu', 'lounasta','lounaalla', 'lounasbuffet', 'lunasbuffet', 'lounasbufee', 'buffetlounaan', 'lounaan hinta', 'lounaan', 'lounas', 'arkisin', 'noutopöytä', 'seisova pöytä', 'keittolounas',],
            ...
            'brunch_simple_sv': ['brunch', 'helgmeny', 'helglunch', 'helgen', 'helger', 'veckans slut', 'veckansslut', 'veckoslut', 'högtider', 'helgdag', 'helgdagar', 'lördagsbuffé', 'lördagsmeny'],
            ...
            'schedule_open_hours_en': ['opening hours', 'working hours',],
            ...
            'closed_sv': ['är stängda', 'stängt', 'stängd', 'lunchstängt', 'lunchstängd', 'privat evenemang', 'privatevenemang', 'sommaruppehållet', 'tillbaka i affärer', 'kommer snart', 'coming soon',],
            ...
            'exclusions_sv': exclusions_common + ['för några dagar', 'bokad', 'ingen meny idag', 'vi förbehåller oss rättigheterna till möjliga förändringar', 'rättigheter till möjliga förändringar', 'till möjliga förändringar', 'gastrogates', 'accepterar', 'minlunchguide', 'lunchguide', 'lunch guide', 'bunchguide', 'bunch guide', 'guide', 'anpassa kakor', 'sparar informationen', 'kakor du vill', 'alltid aktiv', 'inte inaktiveras', 'statistik och analys', 'kakor är inaktiverade', 'vår webbplats', 'inställningar väljer', 'upphovsrättslagen', 'upphovsrätts', 'hovsrättslagen'],  # ignore strings with these items
            # 'Oy', 
