...
class check_in_dict():
    ...
    def __init__(self):
        ...
        self.words = {
            ...
            'lngs': {'fi-fi': 'fi', 'fin': 'fi', 'fi': 'fi', 'en-en': 'en', 'en-gb': 'en', 'en-us': 'en', 'en-ca': 'en', 'en-in': 'en', 'en-au': 'en', 'en-nz': 'en', 'en-za': 'en', 'en': 'en', 'se-se': 'se', 'se': 'se', },
            ...
            'closed_permanent_en': ['har permanent stängd', 'permanent stängd', 'stängd permanent', 'stängd för gott', 'stänger sina dörrar', 'stängde sina dörrar', 'beslutade att stänga dörrarna för gott', 'beslutade att stänga dörrar', 'business stänger sina dörrar', 'business stänger'],
