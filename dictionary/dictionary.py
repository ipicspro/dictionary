...
class check_in_dict():
    ...
    def __init__(self):
        ...
        self.words = {
            ...
            'exclusions_sv': exclusions_common + ['för några dagar', 'bokad', 'ingen meny idag', 'vi förbehåller oss rättigheterna till möjliga förändringar', 'rättigheter till möjliga förändringar', 'till möjliga förändringar', 'gastrogates', 'accepterar', 'minlunchguide', 'lunchguide', 'lunch guide', 'bunchguide', 'bunch guide', 'guide', 'anpassa kakor', 'sparar informationen', 'kakor du vill', 'alltid aktiv', 'inte inaktiveras', 'statistik och analys', 'kakor är inaktiverade', 'vår webbplats', 'inställningar väljer'],  # ignore strings with these items
            # 'Oy', 
