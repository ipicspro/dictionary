...
class check_in_dict():
    ...
    def __init__(self):
        ...
        self.words = {
            ...
            'exclusions_sv': exclusions_common + ["för några dagar", "bokad", "ingen meny idag", "vi förbehåller oss rättigheterna till möjliga förändringar", "rättigheter till möjliga förändringar", "till möjliga förändringar", "gastrogates", "accepterar"],  # ignore strings with these items
            # 'Oy', 
